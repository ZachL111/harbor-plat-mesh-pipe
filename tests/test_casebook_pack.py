"""Regression checks for the harbor-plat-mesh-pipe casebook."""
...
from casebook.harness import assert_expected, harbor_plat_mesh_pipe_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(harbor_plat_mesh_pipe_summary(), assert_expected())
