...
powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-harbor-plat-mesh-detail.ps1

powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-harbor-plat-mesh-properties.ps1
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }

powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-harbor-plat-mesh-golden.ps1
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }

powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-harbor_plat_mesh_pipe-casebook.ps1
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }
