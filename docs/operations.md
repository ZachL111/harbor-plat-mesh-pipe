...
`harbor-plat-mesh-pipe` is centered on platform engineering work in Java. The technical target is: Package a Java local lab for mesh analysis with safe and unsafe fixtures, remediation hints, and documented operating limits.
...
The score is deterministic. The current threshold is 181. Risk has a penalty of 7, latency has a penalty of 3, and weight contributes a bonus of 2.
